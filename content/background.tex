...
%	
	...
	\subsubsection{LORIA \TODO{title}}
	\label{sec:capt:systems:loria}
	...
	%
	 \TODO{\textit{This part about segmentation doesn't really fit in with the CAPT systems discussion - find a better place for it.}}
...
%which this group has developed will be instrumental in the construction of the CAPT tool. 
	...
	\subsubsection{CMU \TODO{title}}
	\label{sec:capt:systems:cmu}
