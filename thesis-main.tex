...
\documentclass[%
	...
	twoside=false,				% onesite or twoside printing 	%TODO true in final
...
\input{content/background} 	% INCLUDE: background & related work
\input{content/diagnosis}			% INCLUDE: diagnosis
\input{content/feedback}			% INCLUDE: feedback
%\input{content/future}				% INCLUDE: future work
