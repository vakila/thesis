...
Minimum	&	23.21\%	&	-0.01	\\
	...
	\begin{itemize}%[topsep=-.5em]
	 ...
	 \item \TODO{which of the prosodic features discussed in \cref{sec:diag:prosody}} are most useful for classification, and
	 \item whether a classification-based approach can lead to reasonably accurate diagnosis for words or speakers not seen in the training data. \TODO{explain}
	 \end{itemize}
	% The remainder of this section describes these experiments, and \cref{sec:results} presents their findings. 
	
	 
	 The WEKA machine learning toolkit\TODO{footnote URL} was used to train and evaluate classifiers for these experiments. In this work, only simple Classification And Regression Tree (CART) classifiers were used.
