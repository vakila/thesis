...
\begin{textblock}{7}(9, 2.5) {
\banner
} \end{textblock}
\begin{textblock}{6.75}(9.25,2.75){
...
\begin{textblock}{6.75}(9.25,17.25){
 ...
 \begin{textblock}{4}(12,17.9)
  
  	\begin{figure}
	%\centering
	%\fcolorbox{gray!50}{white}{\includegraphics[width=.7\textwidth]{../FeedbackMethod}}
	\includegraphics[width=.9\textwidth]{../../../img/screenshots/TeacherInterface-smaller-er}
