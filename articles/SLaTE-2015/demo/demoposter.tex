...
\vspace{1em}
	...
	\caption{Feedback via graphical visualization (blue/green rectangles), text stylization (syllable text below rectangles), learner utterance playback (audio controls), and verbal message (green text).}
	\label{fig:feedback}
	\end{figure}
...
\end{textblock}
  ...
  \begin{textblock}{7}(9, 18.75) {
\banner
} \end{textblock}
\begin{textblock}{6.75}(9.25,19){
  \LHead{\titlecolor Administrative interface for teachers/researchers}}
 \end{textblock}
 \begin{textblock}{7}(9, 19.75)
  \Textsize
