...
%knowledge of the text of the given utterance (known beforehand in the IFCASL case), 
	...
	\TODO{de-stress} only makes use of the automatically-determined boundaries, even though these are potentially less accurate; 
...
\label{sec:diag:system}
	...
	In the \TODO{de-stress} CAPT tool, a  researcher (or teacher) can choose between the various possible approaches for diagnosing lexical stress errors in learner's speech which have been discussed in this chapter. 
