...
\DeclareGraphicsRule{.bw.png}{png}{.bw.png}{}
\DeclareGraphicsExtensions{.bw.png,.png,.pdf}

\RequirePackage{enumitem}			% for simple list modifications
\setlist[itemize,enumerate]{itemsep=.2em, beginpenalty=5000, midpenalty=10000} 
...
\newcommand{\thesisDate}{10 September, 2014}
