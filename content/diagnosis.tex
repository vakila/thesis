...
\begin{table}[htb]
		\centering
		\caption[Features computed for duration analysis]{Features computed for duration analysis, and their values for the sample utterances in \cref{fig:featuresexample}. Values are given in seconds.}
		\begin{tabularx}{\textwidth}{lXcc}
		\toprule
		\multirow{2}{*}{Feature name} 
									& \multirow{2}{*}{Description}
																	& \multicolumn{2}{c}{Value (seconds)} \\
					  				&												&  (a) Flagge-F		& (b) Flagge-G \\
		\midrule
		WORD\_DUR 		&	Duration of entire word				& 0.32			& 0.33			\\
		SYLL0\_DUR 		&	Dur. of first syllable						& 0.16			& 0.22			\\
		SYLL1\_DUR 		&	Dur. of second syllable				& 0.16			& 0.11			\\
		V0\_DUR 				&	Dur. of vowel in first syllable		& 0.04			& 0.09			\\
		V1\_DUR 				&	Dur. of vowel in second syllable	& 0.06			& 0.05			\\
		SYLL\_REL\_DUR 	&	SYLL0\_DUR$/$SYLL1\_DUR 		& 1.00			& 2.00			\\
		V\_REL\_DUR 		&	V0\_DUR$/$V1\_DUR					& 0.67			& 1.80 			\\
		\bottomrule	
		\end{tabularx}
