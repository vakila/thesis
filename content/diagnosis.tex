...
%	\TODO{Can use WEKA classifiers using just the relevant feature types to assign a score }
	...
	In the current implementation, this combination consists of simply 
