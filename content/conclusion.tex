...
%below.
	...
	%
	In a future version of \TODO{de-stress}, this function could be served by the use of a simple sentence- and/or word-level confidence measure for the segmentation of a given utterance. 
	...
	Another useful extension of \TODO{de-stress} could be the inclusion of the type of error-filtering methods described by \textcite{Bonneau2012,Orosanu2012}, which detect and reject utterances which do not correspond to the expected text before alignment is attempted.
	...
	With respect to the diagnosis module of \TODO{de-capt}, multiple directions for future improvements present themselves. 
...
%   ...online, semi-supervised learning which could allow the system to benefit from each new utterance recorded as a learner continues to use the system.
	...
	Finally, several additional types of feedback could be added to the variety currently implemented in \TODO{de-stress}; possibilities may include metalinguistic feedback (e.g. reminders of stress placement rules in German), ``gamification'' (e.g. awarding points for correct realizations), or interactivity (e.g. allowing the learner to manipulate the prosody of an utterance via resynthesis). 
