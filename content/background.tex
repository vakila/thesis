...
by
resynthesizing the learner's utterance to match the pitch contour and timing of the reference, without modifying the voice quality of the utterance, such that the learner can hear the ``correct'' pronunciation in their own voice (see \cref{sec:implicit:auditory:resynth}). 
%
...
prosodically-modified recordings of their own speech and that of native speakers (see \cref{sec:implicit:auditory:resynth} for a discussion of how similar feedback is delivered by \TODO{de-stress}).
