...
{\normalsize Towards a CAPT system for French learners of German}}
...
\begin{frame}{Lexical stress errors in CAPT}
\begin{figure}
\centering
%\includegraphics<1>[width=.7\textwidth]{venn-colloquium-1}
%\includegraphics<2>[width=.7\textwidth]{venn-colloquium-12}
%\includegraphics<3>[width=.7\textwidth]{venn-colloquium-all3}
\includegraphics[width=.7\textwidth]{venn-colloquium-full-footnotes-2}
\end{figure}

\footnotetext[1]{\fullcite{Hirschfeld1994}}
\footnotetext[2]{\fullcite{Bonneau2011}}
\footnotetext[3]{\fullcite{Kim2011}}
...
\end{frame}
	...
	\subsection{Annotation of a learner speech corpus}
		...
		%\TODO{Explain/remove abbreviations}
		Data: IFCASL corpus of French-German speech\footfullcite{Fauth2014}
		\begin{itemize}
...
%				}
%			\item{Phonetics/phonology expertise: \\
%			2 Experts, 10 Intermediates, 3 Novices
%%				\begin{itemize}
%%				\item 2 Experts
%%				\item 10 Intermediates
%%				\item 3 Novices
...
%		\begin{figure}
%		\includegraphics[height=.4\textheight]{AnnotationTool-withLabels-cropped}
%		\end{figure}
%		
...
%\newcounter{currentframecount}
%\setcounter{currentframecount}{\value{framenumber}}
%\setcounter{framenumber}{3}
{\setbeamertemplate{footline}{} 
\againframe[noframenumbering]{outline}
}
%\setcounter{framenumber}{\value{currentframecount}}
...
%		
	...
	%\subsection{Self-assessment as feedback}
		...
		May be linked to progress and motivation\footfullcite{Neri2002}
...
%		\end{frame}
		...
		\begin{frame}{Teacher/Researcher interface}
%		\begin{figure}
%		\includegraphics[width=.5\textwidth]{createDM}
%		\hspace{1mm}
%		\includegraphics[width=.5\textwidth]{createFM}
%		\end{figure}
...
\frametitle{Thanks for listening!}
 {\small   \structure{\textbf{Many thanks to:}}}
