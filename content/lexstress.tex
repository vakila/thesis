...
%			\end{table}
			...
			\begin{table}[tbp]
				\centering
				\caption[Errors by word type]{Tokens (utterances) assigned to each of the five categories, listed by word type. Equivalent percentages of each word type's total number of tokens are given in parentheses.}
...
%			\end{table}		
		...
		\begin{table}
			\caption{Errors by speaker skill level \TODO{\%ages}}
