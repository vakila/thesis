...
%		
			...
			\end{figure}	
				...
				(the majority at the A2 level with only 2 girls at B1),
				...
				and \cref{fig:results:agepies:adultbeg} illustrates the error distribution for the latter group \TODO{include adult A2 chart also? (distribution is quite similar to A2/B1)}. 
